...
const feedbackText = "카르페디엠님의 자세는 전반적으로 양호했지만 개선의 여지가 있습니다. 운동하는 동안 등을 곧게 펴고 코어를 움직이도록 집중하세요.";
...
const recommendedVideos = [
  ...
  { id: 2, thumbnail: 'https://via.placeholder.com/150x100?text=Video+2', title: '코어 강화 운동' },
];
...
const AIScoreEvaluationPage = () => {
  return (
    <div className="ai-score-evaluation-page-container">
      ...
      <ActionButtons onSave={() => console.log('저장하기')} onShare={() => console.log('공유하기')} />
    </div>
  );
};
