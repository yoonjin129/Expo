...
function DietPage() {
  ...
  const recommendedMeals = {
    아침: [
      { title: '귀리죽 + 삶은 달걀 1개 + 사과 한 조각', info: '탄수화물: 55g / 단백질: 20g / 지방: 12g', time: '약 12분', img: '/images/아침 - 귀리죽.png' },
      { title: '통밀 토스트 2장 + 닭가슴살 슬라이스 + 바나나', info: '탄수화물: 60g / 단백질: 25g / 지방: 15g', time: '약 15분', img: '/images/아침 - 토스트.png' },
      { title: '그릭 요거트 150g + 견과류 한 줌 + 블루베리', info: '탄수화물: 50g / 단백질: 20g / 지방: 15g', time: '약 5분', img: '/images/아침 - 그릭요거트.png' },
    ],
    점심: [
      { title: '닭가슴살 샌드위치 + 채소', info: '탄수화물: 55g / 단백질: 30g / 지방: 10g', time: '약 10분', img: '/images/점심 - 토스트.png' },
      { title: '통밀 파스타 100g + 닭가슴살 + 토마토 소스', info: '탄수화물: 70g / 단백질: 35g / 지방: 15g', time: '약 25분', img: '/images/점심 - 파스타.png' },
      { title: '잡곡밥 150g + 돼지고기 볶음 + 채소볶음', info: '탄수화물: 60g / 단백질: 35g / 지방: 18g', time: '약 25분', img: '/images/점심 - 볶음.png' },
    ],
    저녁: [
      { title: '닭가슴살 구이 + 고구마 150g + 채소 스팀', info: '탄수화물: 60g / 단백질: 35g / 지방: 15g', time: '약 20분', img: '/images/저녁 - 야채 스팀.png' },
      { title: '소고기 장조림 + 밥 100g + 나물무침', info: '탄수화물: 50g / 단백질: 30g / 지방: 15g', time: '약 20분', img: '/images/저녁 - 장조림.png' },
      { title: '두부조림 + 밥 100g + 김치', info: '탄수화물: 55g / 단백질: 25g / 지방: 12g', time: '약 15분', img: '/images/저녁 - 두부조림.png' },
    ],
  };
    ...
    <div className="container">
      ...
      <section className="today-meals">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <h3>오늘 나의 식단</h3>
          {editMode ? (
            <button className="all-btn" onClick={handleSaveClick}>저장</button>
          ) : (
            <button className="all-btn" onClick={handleEditClick}>수정하기</button>
          )}
        </div>
